...
<div class="widget purple">
                         ...
                         <div class="widget-body">
                             <div class="row-fluid">
                              ...
                              <?php   
	$idd=$_GET['id'];
	$result = mysqli_query($conn,"SELECT * FROM sales WHERE IDInvoice='$idd'");
  ...
  ?>
	...
	$result = mysqli_query($conn,"SELECT * FROM product WHERE productid='$IDProduct'");
	while($dec = mysqli_fetch_array($result))
			{ 
  ...
  ?>
                             ...
                             <div class="row-fluid text-center">
                                 ...
                                 <a class="btn btn-inverse btn-large hidden-print" onClick="Back()">Back <i class="icon-backward"></i></a>
                             </div>
                         </div>
                     </div>
