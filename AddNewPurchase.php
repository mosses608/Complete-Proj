                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="Execute/ExPurchasing.php" method="post" class="form-horizontal" id="product-validate" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="QuatityInStore" name="QuatityInStore" class="form-control" readonly value="<?php echo $quantity + (isset($data['Quantity']) ? $data['Quantity'] : 0) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="Quantity2" name="Quantity2" class="form-control" value="<?php echo isset($data['Quantity']) ? $data['Quantity'] : '' ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 ">
                                              <input type="text" id="Price" name="Price"  value="<?php echo isset($data['Price']) ? $data['Price'] : '' ?>" class="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="SupplierName" name="SupplierName" class="form-control" value="<?php echo isset($data['SupplierName']) ? $data['SupplierName'] : '' ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="SupplierPhone" name="SupplierPhone" class="form-control" data-mask="+250799 999 999"  value="<?php echo isset($data['SupplierPhone']) ? $data['SupplierPhone'] : '' ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="date" id="date2" name="date2" class="form-control"  value="<?php echo isset($data['Date']) ? date("Y-m-d",strtotime($data['Date'])) : '' ?>" />
                                            </div>
                                        </div>
