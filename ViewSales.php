					...
					?>
                                        <tr class="odd gradeX">
                                           ...
                                           <td>
                                            ...
                                            <td class="center">
                                            <a href="AddNewSales.php?id=<?php echo $product['IDProduct'];?>&pid=<?php echo $product['salesid'];?>">
                                            <button class="btn btn-primary"><i class="icon-pencil icon-white"></i></button> </a>
                                            
                                            <a href="AddNewSales.php?id=<?php echo $product['IDProduct'];?>&pid=<?php echo $product['salesid'];?>">
                                            <a class="btn btn-danger" href="Execute/ExDelSales.php?sid=<?php echo $product['salesid'] ?>"><i class="icon-remove icon-white"></i></a> </a>
