                                           ...
                                           <td>
                                            <?php 
												$IDProduct=$product['IDProduct'];
                                           		 $quer= mysqli_query($conn,"SELECT DISTINCT product_name FROM product where productid='$IDProduct'");
                                            ...
                                            <td class="center">
                                            <a href="AddNewPurchase.php?id=<?php echo $product['IDProduct'];?>&pid=<?php echo $product['purchaseid'];?>">
                                            <button class="btn btn-primary"><i class="icon-pencil icon-white"></i></button> </a>
                                            
                                           
                                            <a class="btn btn-danger" href="Execute/ExDelPur.php?pid=<?php echo $product['purchaseid'] ?>"><i class="icon-remove icon-white"></i></a> 
