...
<body class="padTop53 ">
 ...
 if(isset($_GET['pid'])){
    $qry = mysqli_query($conn, "SELECT * FROM sales where salesid = {$_GET['pid']} ");
 ...
 ?> 
                                ...
                                <span class="input-group-addon add-on" data-toggle="modal" data-target="#NewInvoiceNumber"><i class=" icon-plus"></i></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="QuatityInStore" name="QuatityInStore" class="form-control" readonly value="<?php echo $quantity + (isset($data['QuantitySold']) ? $data['QuantitySold'] : 0) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="Quantity2" name="Quantity2" class="form-control" value="<?php echo isset($data['QuantitySold']) ? $data['QuantitySold'] : '' ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="TotalPrice2" name="TotalPrice2" class="form-control"  value="<?php echo isset($data['TotalPrice']) ? $data['TotalPrice'] : '' ?>" readonly />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="AmountPaid" name="AmountPaid" class="form-control"  value="<?php echo isset($data['AmountPaid']) ? $data['AmountPaid'] : '' ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="Balance" name="Balance" class="form-control" readonly  value="<?php echo isset($data['Balance']) ? $data['Balance'] : '' ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="ClientName" name="ClientName" class="form-control"  value="<?php echo isset($data['ClientName']) ? $data['ClientName'] : '' ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="ClientPhone" name="ClientPhone" class="form-control" data-mask="+250 999 999 999"  value="<?php echo isset($data['PhoneNumber']) ? $data['PhoneNumber'] : '' ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="date" id="date2" name="date2" class="form-control"  value="<?php echo isset($data['SaleDate']) ? date("Y-m-d",strtotime($data['SaleDate'])) : '' ?>" />
                                            </div>
                                        </div>
