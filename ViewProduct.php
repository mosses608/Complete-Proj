					...
					?>
                                        <tr class="odd gradeX">
                                            ...
                                            <?php 
                                                ...
                                                $Price = 0;
                                           		 $quer= mysqli_query($conn,"SELECT DISTINCT Price FROM price where IDProduct='$IDProduct'");
                                            ...
                                            <a class="btn btn-danger" href="Execute/ExDelProd.php?pid=<?php echo $IDProduct ?>"><i class="icon-remove icon-white"></i> </a>
